...
type Article struct {
	...
	ImageUrls    []string `protobuf:"bytes,6,rep,name=image_urls,json=imageUrls,proto3" json:"image_urls,omitempty"`            // 图片 URL 列表
	CoverImage   string   `protobuf:"bytes,7,opt,name=cover_image,json=coverImage,proto3" json:"cover_image,omitempty"`         // 封面图片 URL
	...
	CreatedAt    int64    `protobuf:"varint,14,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`          // 创建时间（ISO 8601 格式）
	UpdatedAt    int64    `protobuf:"varint,15,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`          // 更新时间（ISO 8601 格式）
	DeletedAt    int64    `protobuf:"varint,16,opt,name=deleted_at,json=deletedAt,proto3" json:"deleted_at,omitempty"`          // 删除时间（ISO 8601 格式，可为空）
}
...
type CreateArticleRequest struct {
	...
	ImageUrls  []string `protobuf:"bytes,5,rep,name=image_urls,json=imageUrls,proto3" json:"image_urls,omitempty"`    // 图片 URL 列表
	CoverImage string   `protobuf:"bytes,6,opt,name=cover_image,json=coverImage,proto3" json:"cover_image,omitempty"` // 封面图片 URL
...
func (x *CreateArticleRequest) GetImageUrls() []string {
	if x != nil {
		return x.ImageUrls
	}
	return nil
...
func (x *UpdateArticleRequest) GetImageUrls() []string {
	if x != nil {
		return x.ImageUrls
	}
	return nil
...
var file_articles_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x61, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x73, 0x22, 0xc0, 0x03, 0x0a, 0x07, 0x41,
	...
	0x6d, 0x61, 0x72, 0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x5f, 0x75, 0x72,
	0x6c, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x55,
	0x72, 0x6c, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x5f, 0x69, 0x6d, 0x61,
	...
	0x74, 0x69, 0x63, 0x6c, 0x65, 0x22, 0xfd, 0x01, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x52, 0x09, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x55, 0x72, 0x6c, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x63,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x27, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41,
	...
	0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x5f, 0x75, 0x72, 0x6c, 0x73, 0x18,
	0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x55, 0x72, 0x6c, 0x73,
	...
	0x63, 0x65, 0x73, 0x73, 0x32, 0xcf, 0x02, 0x0a, 0x0e, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x47, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x41, 0x72,
	0x74, 0x69, 0x63, 0x6c, 0x65, 0x12, 0x1b, 0x2e, 0x61, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x73,
	0x2e, 0x47, 0x65, 0x74, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x61, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x73, 0x2e, 0x47, 0x65,
	...
	0x74, 0x1a, 0x1f, 0x2e, 0x61, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x73, 0x2e, 0x43, 0x72, 0x65,
	...
	0x63, 0x6c, 0x65, 0x12, 0x1e, 0x2e, 0x61, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x73, 0x2e, 0x55,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x1f, 0x2e, 0x61, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x73, 0x2e, 0x55,
	...
	0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x61, 0x72, 0x74, 0x69,
...
var file_articles_proto_goTypes = []any{
	...
	(*GetArticleRequest)(nil),     // 1: articles.GetArticleRequest
	(*GetArticleResponse)(nil),    // 2: articles.GetArticleResponse
	(*CreateArticleRequest)(nil),  // 3: articles.CreateArticleRequest
	(*CreateArticleResponse)(nil), // 4: articles.CreateArticleResponse
	(*UpdateArticleRequest)(nil),  // 5: articles.UpdateArticleRequest
	(*UpdateArticleResponse)(nil), // 6: articles.UpdateArticleResponse
	(*DeleteArticleRequest)(nil),  // 7: articles.DeleteArticleRequest
	(*DeleteArticleResponse)(nil), // 8: articles.DeleteArticleResponse
}
var file_articles_proto_depIdxs = []int32{
	0, // 0: articles.GetArticleResponse.article:type_name -> articles.Article
	1, // 1: articles.ArticleService.GetArticle:input_type -> articles.GetArticleRequest
	3, // 2: articles.ArticleService.CreateArticle:input_type -> articles.CreateArticleRequest
	5, // 3: articles.ArticleService.UpdateArticle:input_type -> articles.UpdateArticleRequest
	7, // 4: articles.ArticleService.DeleteArticle:input_type -> articles.DeleteArticleRequest
	2, // 5: articles.ArticleService.GetArticle:output_type -> articles.GetArticleResponse
	4, // 6: articles.ArticleService.CreateArticle:output_type -> articles.CreateArticleResponse
	6, // 7: articles.ArticleService.UpdateArticle:output_type -> articles.UpdateArticleResponse
	8, // 8: articles.ArticleService.DeleteArticle:output_type -> articles.DeleteArticleResponse
