...
var file_coderhub_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x32, 0xdd,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x63, 0x6f, 0x64,
...
var file_coderhub_proto_msgTypes = make([]protoimpl.MessageInfo, 97)
...
var file_coderhub_proto_depIdxs = []int32{
	...
	8,  // 29: coderhub.UserService.BatchGetUserByID:input_type -> coderhub.BatchGetUserByIDRequest
	11, // 30: coderhub.UserService.UpdateUserInfo:input_type -> coderhub.UpdateUserInfoRequest
	13, // 31: coderhub.UserService.UploadAvatar:input_type -> coderhub.UploadAvatarRequest
	17, // 32: coderhub.UserService.ChangePassword:input_type -> coderhub.ChangePasswordRequest
	19, // 33: coderhub.UserService.ResetPassword:input_type -> coderhub.ResetPasswordRequest
	21, // 34: coderhub.UserService.ResetPasswordByLink:input_type -> coderhub.ResetPasswordByLinkRequest
	23, // 35: coderhub.UserService.DeleteUser:input_type -> coderhub.DeleteUserRequest
	25, // 36: coderhub.UserFollowService.CreateUserFollow:input_type -> coderhub.CreateUserFollowReq
	27, // 37: coderhub.UserFollowService.DeleteUserFollow:input_type -> coderhub.DeleteUserFollowReq
	29, // 38: coderhub.UserFollowService.GetUserFollows:input_type -> coderhub.GetUserFollowsReq
	31, // 39: coderhub.UserFollowService.GetUserFans:input_type -> coderhub.GetUserFansReq
	33, // 40: coderhub.UserFollowService.IsUserFollowed:input_type -> coderhub.IsUserFollowedReq
	35, // 41: coderhub.UserFollowService.GetMutualFollows:input_type -> coderhub.GetMutualFollowsReq
	38, // 42: coderhub.AcademicNavigatorService.AddAcademicNavigator:input_type -> coderhub.AddAcademicNavigatorRequest
	39, // 43: coderhub.AcademicNavigatorService.GetAcademicNavigator:input_type -> coderhub.GetAcademicNavigatorRequest
	40, // 44: coderhub.AcademicNavigatorService.DeleteAcademicNavigator:input_type -> coderhub.DeleteAcademicNavigatorRequest
	44, // 45: coderhub.AcademicNavigatorService.LikeAcademicNavigator:input_type -> coderhub.LikeAcademicNavigatorRequest
	45, // 46: coderhub.AcademicNavigatorService.CancelLikeAcademicNavigator:input_type -> coderhub.CancelLikeAcademicNavigatorRequest
	48, // 47: coderhub.ArticleService.GetArticle:input_type -> coderhub.GetArticleRequest
	50, // 48: coderhub.ArticleService.CreateArticle:input_type -> coderhub.CreateArticleRequest
	52, // 49: coderhub.ArticleService.UpdateArticle:input_type -> coderhub.UpdateArticleRequest
	54, // 50: coderhub.ArticleService.UpdateLikeCount:input_type -> coderhub.UpdateLikeCountRequest
	56, // 51: coderhub.ArticleService.DeleteArticle:input_type -> coderhub.DeleteArticleRequest
	61, // 52: coderhub.CommentService.CreateComment:input_type -> coderhub.CreateCommentRequest
	63, // 53: coderhub.CommentService.GetComments:input_type -> coderhub.GetCommentsRequest
	65, // 54: coderhub.CommentService.GetCommentReplies:input_type -> coderhub.GetCommentRepliesRequest
	58, // 55: coderhub.CommentService.UpdateCommentLikeCount:input_type -> coderhub.UpdateCommentLikeCountRequest
	67, // 56: coderhub.CommentService.GetComment:input_type -> coderhub.GetCommentRequest
	69, // 57: coderhub.CommentService.DeleteComment:input_type -> coderhub.DeleteCommentRequest
	72, // 58: coderhub.ImageRelationService.CreateRelation:input_type -> coderhub.CreateRelationRequest
	74, // 59: coderhub.ImageRelationService.BatchCreateRelation:input_type -> coderhub.BatchCreateRelationRequest
	76, // 60: coderhub.ImageRelationService.BatchDeleteRelation:input_type -> coderhub.BatchDeleteRelationRequest
	78, // 61: coderhub.ImageRelationService.BatchGetImagesByEntity:input_type -> coderhub.BatchGetImagesByEntityRequest
	80, // 62: coderhub.ImageRelationService.DeleteByEntityID:input_type -> coderhub.DeleteByEntityIDRequest
	82, // 63: coderhub.ImageRelationService.GetImagesByEntity:input_type -> coderhub.GetImagesByEntityRequest
	84, // 64: coderhub.ImageRelationService.GetEntitiesByImage:input_type -> coderhub.GetEntitiesByImageRequest
	88, // 65: coderhub.ImageService.Upload:input_type -> coderhub.UploadRequest
	89, // 66: coderhub.ImageService.Delete:input_type -> coderhub.DeleteRequest
	93, // 67: coderhub.ImageService.Get:input_type -> coderhub.GetRequest
	91, // 68: coderhub.ImageService.BatchGet:input_type -> coderhub.BatchGetRequest
	94, // 69: coderhub.ImageService.ListByUser:input_type -> coderhub.ListByUserRequest
	...
	10, // 73: coderhub.UserService.GetUserInfo:output_type -> coderhub.UserInfo
	10, // 74: coderhub.UserService.GetUserInfoByUsername:output_type -> coderhub.UserInfo
	9,  // 75: coderhub.UserService.BatchGetUserByID:output_type -> coderhub.BatchGetUserByIDResponse
	12, // 76: coderhub.UserService.UpdateUserInfo:output_type -> coderhub.UpdateUserInfoResponse
	14, // 77: coderhub.UserService.UploadAvatar:output_type -> coderhub.UploadAvatarResponse
	18, // 78: coderhub.UserService.ChangePassword:output_type -> coderhub.ChangePasswordResponse
	20, // 79: coderhub.UserService.ResetPassword:output_type -> coderhub.ResetPasswordResponse
	22, // 80: coderhub.UserService.ResetPasswordByLink:output_type -> coderhub.ResetPasswordByLinkResponse
	24, // 81: coderhub.UserService.DeleteUser:output_type -> coderhub.DeleteUserResponse
	26, // 82: coderhub.UserFollowService.CreateUserFollow:output_type -> coderhub.CreateUserFollowResp
	28, // 83: coderhub.UserFollowService.DeleteUserFollow:output_type -> coderhub.DeleteUserFollowResp
	30, // 84: coderhub.UserFollowService.GetUserFollows:output_type -> coderhub.GetUserFollowsResp
	32, // 85: coderhub.UserFollowService.GetUserFans:output_type -> coderhub.GetUserFansResp
	34, // 86: coderhub.UserFollowService.IsUserFollowed:output_type -> coderhub.IsUserFollowedResp
	36, // 87: coderhub.UserFollowService.GetMutualFollows:output_type -> coderhub.GetMutualFollowsResp
	41, // 88: coderhub.AcademicNavigatorService.AddAcademicNavigator:output_type -> coderhub.Response
	43, // 89: coderhub.AcademicNavigatorService.GetAcademicNavigator:output_type -> coderhub.GetAcademicNavigatorResponse
	41, // 90: coderhub.AcademicNavigatorService.DeleteAcademicNavigator:output_type -> coderhub.Response
	41, // 91: coderhub.AcademicNavigatorService.LikeAcademicNavigator:output_type -> coderhub.Response
	41, // 92: coderhub.AcademicNavigatorService.CancelLikeAcademicNavigator:output_type -> coderhub.Response
	49, // 93: coderhub.ArticleService.GetArticle:output_type -> coderhub.GetArticleResponse
	51, // 94: coderhub.ArticleService.CreateArticle:output_type -> coderhub.CreateArticleResponse
	53, // 95: coderhub.ArticleService.UpdateArticle:output_type -> coderhub.UpdateArticleResponse
	55, // 96: coderhub.ArticleService.UpdateLikeCount:output_type -> coderhub.UpdateLikeCountResponse
	57, // 97: coderhub.ArticleService.DeleteArticle:output_type -> coderhub.DeleteArticleResponse
	62, // 98: coderhub.CommentService.CreateComment:output_type -> coderhub.CreateCommentResponse
	64, // 99: coderhub.CommentService.GetComments:output_type -> coderhub.GetCommentsResponse
	66, // 100: coderhub.CommentService.GetCommentReplies:output_type -> coderhub.GetCommentRepliesResponse
	59, // 101: coderhub.CommentService.UpdateCommentLikeCount:output_type -> coderhub.UpdateCommentLikeCountResponse
	68, // 102: coderhub.CommentService.GetComment:output_type -> coderhub.GetCommentResponse
	70, // 103: coderhub.CommentService.DeleteComment:output_type -> coderhub.DeleteCommentResponse
	73, // 104: coderhub.ImageRelationService.CreateRelation:output_type -> coderhub.CreateRelationResponse
	75, // 105: coderhub.ImageRelationService.BatchCreateRelation:output_type -> coderhub.BatchCreateRelationResponse
	77, // 106: coderhub.ImageRelationService.BatchDeleteRelation:output_type -> coderhub.BatchDeleteRelationResponse
	79, // 107: coderhub.ImageRelationService.BatchGetImagesByEntity:output_type -> coderhub.BatchGetImagesByEntityResponse
	81, // 108: coderhub.ImageRelationService.DeleteByEntityID:output_type -> coderhub.DeleteByEntityIDResponse
	83, // 109: coderhub.ImageRelationService.GetImagesByEntity:output_type -> coderhub.GetImagesByEntityResponse
	85, // 110: coderhub.ImageRelationService.GetEntitiesByImage:output_type -> coderhub.GetEntitiesByImageResponse
	86, // 111: coderhub.ImageService.Upload:output_type -> coderhub.ImageInfo
	90, // 112: coderhub.ImageService.Delete:output_type -> coderhub.DeleteResponse
	86, // 113: coderhub.ImageService.Get:output_type -> coderhub.ImageInfo
	92, // 114: coderhub.ImageService.BatchGet:output_type -> coderhub.BatchGetResponse
	95, // 115: coderhub.ImageService.ListByUser:output_type -> coderhub.ListByUserResponse
