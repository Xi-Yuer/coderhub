...
type (
	...
	defaultFavorService struct {
		cli zrpc.Client
	}
)

func NewFavorService(cli zrpc.Client) FavorService {
	return &defaultFavorService{
		cli: cli,
	}
}

// 创建
func (m *defaultFavorService) CreateFavor(ctx context.Context, in *CreateFavorRequest, opts ...grpc.CallOption) (*CreateFavorResponse, error) {
	client := coderhub.NewFavorServiceClient(m.cli.Conn())
	return client.CreateFavor(ctx, in, opts...)
}

// 删除
func (m *defaultFavorService) DeleteFavor(ctx context.Context, in *DeleteFavorRequest, opts ...grpc.CallOption) (*DeleteFavorResponse, error) {
	client := coderhub.NewFavorServiceClient(m.cli.Conn())
	return client.DeleteFavor(ctx, in, opts...)
}

// 获取列表
func (m *defaultFavorService) GetFavorList(ctx context.Context, in *GetFavorListRequest, opts ...grpc.CallOption) (*GetFavorListResponse, error) {
	client := coderhub.NewFavorServiceClient(m.cli.Conn())
